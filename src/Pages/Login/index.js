...
export default function Login() {
  ...
  const { errorSignUp, loadingSignUp } = useSelector((state) => state.SignUpReducer);
      ...
      <div className="login__form mx-auto text-center">
        ...
        <div>
          <Modal isOpen={modal} toggle={toggle} >
            <ModalHeader toggle={toggle} className="header__SignUp">Sign Up</ModalHeader>
            <ModalBody  >
              <form className="signUp mx-3 ">
                ...
                <p>
                  ...
                  <input id="matKhau" name="matKhau" className="col-11 m-1" onChange={handleUser} placeholder="" type="password" />
                </p>
                <p>
                  <label for="email" class="floatLabel">Email</label>
                  <input id="email" name="email" className="col-11 m-1" onChange={handleUser} placeholder="" />
                </p>
                <p>
                  <label for="soDt" class="floatLabel">Số Điện Thoại</label>
