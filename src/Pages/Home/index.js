...
export default function Home() {
  const { movieList, movieListUpcoming } = useSelector((state) => state.movieReducer);
        ...
        <div>
          <ul className="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
            <li className="nav-item" role="presentation">
              <a className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Đang chiếu</a>
            </li>
            <li className="nav-item" role="presentation">
              <a className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Sắp chiếu</a>
            </li>
          </ul>
          <div className="tab-content" id="pills-tabContent">
            <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              <div className="list__dangChieu movie__item row movie_list" id="movie">
                {movieList.map((movie) => {
                  return (
        ...
        <div>
          <ul className="nav nav-pills mb-3 news" id="pills-tab" role="tablist">
            <li className="nav-item new__link" role="presentation">
              <a className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home2" role="tab" aria-controls="pills-home" aria-selected="true">Điện ảnh 24H</a>
            </li>
            <li className="nav-item new__link" role="presentation">
              <a className="nav-link " id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile2" role="tab" aria-controls="pills-profile" aria-selected="false">Khuyến mãi</a>
            </li>
          </ul>
          <div className="tab-content" id="pills-tabContent">
            <div className="tab-pane fade show active" id="pills-home2" role="tabpanel" aria-labelledby="pills-home-tab2">
              <div className="row new__list" >
                <div className="col-6" >
                  <img src="https://s3img.vcdn.vn/123phim/2020/10/d497d585fea7704c5106cccb55fd6622.jpg" alt="" />
                  <a className="title" href="https://tix.vn/goc-dien-anh/7956-ngo-thanh-van-chinh-thuc-khoi-dong-cuoc-thi-thiet-ke-trang-phuc-cho-sieu-anh-hung-dau-tien-cua-viet-nam-vinaman">
                ...
                <div className="col-6" >
                  ...
                  <a className="title" href="https://tix.vn/goc-dien-anh/7960-boc-tem-to-hop-giai-tri-moi-toanh-cua-gioi-ha-thanh">
