    ...
    <div className="coWorker">
      <div className="coWorker__content">
        <div className="container">
          <div className="row">
            <div className="col-md-4 coWorker__left">
              <p>TIX</p>
              <div className="row">
            ...
            <div className="col-md-4 coWorker__middle">
              <p>ĐỐI TÁC</p>
            ...
            <div className="col-md-4 coWorker__right">
              <div className="row">
                <div className="col-md-6">
                  <p>MOBILE APP</p>
                  <a>
          ...
          <div className="row coWorker__afterCredit">
            <div className="col-md-2">
              <img
                src="https://tix.vn/app/assets/img/icons/zion-logo.jpg"
                className="img-fluid ziOnIcon"
                alt="true"
              />
            </div>
